        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <form class="form-horizontal" method="POST" action="/admin/transaksi/createwithdraw">
                        @csrf
                        <div class="box-body">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Jumlah Withdraw</label>
                                <div class="col-sm-8">
                                    <input type="text" name="jumlah_withdraw" class="form-control">
                                </div>
                            </div>
                        </div>
